...
# 3.6 : Traitement des valeurs extremes
...
# Partie : 5 Etude des Résidus du modèle ARIMA(2,1,2) &  calcul des anomalies les erreures de prediction

# 6.1 - calcul des anomalies par les erreures de prediction
...
# 6.2  : Constitution des anomalies et du niveau de seuil de detection 
...
# 6.3 : Visualisation du niveau de la courbe des pertes et du seuil
...
# 6.5 : : Visualisation des anomalies sur le graphique 
...
# 6.6 :  modelisation avec data_full
...
# 6.7 : : Visualisation des anomalies sur le graphique 
